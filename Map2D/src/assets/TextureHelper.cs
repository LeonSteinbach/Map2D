...
namespace Map2D.assets
{
    ...
    {
        // Converts a given Texture2D to a 2d array of color values
		...
		// Converts a 2d array of color values to a Texture2D object
		...
		// Returns a scaled version of the given texture
		...
		// Helper function for scaling textures
		...
		// Returns the given texture with a drawn border around it
