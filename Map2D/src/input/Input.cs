...
using System.Linq;
using Map2D.graphics.camera;
using Microsoft.Xna.Framework;
using Microsoft.Xna.Framework.Input;

namespace Map2D.input
{
	public static class Input
	{
		...
		public static Point MouseWorld(Camera camera)
		{
			return camera.ScreenToWorld(currentMouseState.Position.ToVector2()).ToPoint();
		}
